...
tbl_navigationinfo_extend.manifested_tons,
tbl_navigationinfo_extend.manifested_packages,
tbl_navigationinfo_extend.manifested_cbm,
tbl_navigationinfo_extend.tbl_navigationinfo_id 
...
AND tbl_navigationinfo_has_operators.tbl_navigationinfo_id = tbl_navigationinfo_extend.tbl_navigationinfo_id AND tbl_navigationupdateinfo.vessel_Ref_No ='$CBS'
...
'last_port'=>$row[8],
'pier_i'=>$row[9],
'manifested_tons'=>$row[10],
'manifested_packages'=>$row[11],
'manifested_cbm'=>$row[12],
'tbl_navigationinfo_id'=>$row[13]
