...
//WHERE tbl_navigationupdateinfo.vessel_id = vessel_info.id AND tbl_navigationupdateinfo.agent_id = agent.id AND tbl_navigationupdateinfo.agent_id=$agent_id";

$sql = "SELECT DISTINCT vessel_Ref_No AS CBS, vname, agent_id, A_Code ,agentname,naviup_ATBDate from tbl_navigationupdateinfo , pier, vessel_info , agent
WHERE tbl_navigationupdateinfo.vessel_id = vessel_info.id AND tbl_navigationupdateinfo.agent_id = agent.id";
