...
body {
  ...
  <!-- Add Icon in the title of the page -->
  ...
  <h2>
   <div ><u>Next Sailing Vessels</u> <input  type="button" class="btn btn-info" style="background-color: red; font-size: 16px; color: white;" value="Back" onclick=" relocate_home()" style="align-items: center;"></div>

                        <script>
                        function relocate_home()
                        {
                             location.href = "https://portcom.slpa.lk/ccms_ma/pages/";
                        } 
                        </script>
                      </h2>
       ...
       <div class="box-body">
            ...
            <table id='empTable' class='display dataTable' style="font-size: 10.5px;" >
                <thead>
                <tr>
         ...
         //   $query = "SELECT DISTINCT vessel_Ref_No, vname, naviup_ETCDate,naviup_ETCTime, terminal_i, pier_i from tbl_navigationupdateinfo , pier, vessel_info WHERE (pier_i = pier AND visibility_i ='Active' AND vesselstatusinfo_i ='Berth' AND tbl_navigationupdateinfo.vessel_id = vessel_info.id )";
                ...
                $query = "SELECT DISTINCT vessel_Ref_No, vname, naviup_ETCDate, naviup_ETCTime, naviup_ATCDate,naviup_ATCTime, terminal_i, pier_i,vesselstatusinfo_i,naviup_VlsReadyTime, naviup_PilotONBoardTime ,naviup_lastlinecastoff from tbl_navigationupdateinfo , pier, vessel_info WHERE visibility_i ='Active' AND (vesselstatusinfo_i ='AtBerth' OR vesselstatusinfo_i ='At Berth'  OR vesselstatusinfo_i ='Completed' OR vesselstatusinfo_i ='AtBerth(VR)') AND tbl_navigationupdateinfo.vessel_id = vessel_info.id  ORDER BY naviup_ETCTime ASC";
    ...
    <h2>
   <div ><u>Next Arriving Vessel</u> <input  type="button" class="btn btn-info" style="background-color: red; font-size: 16px; color: white;" value="Back" onclick=" relocate_home()" style="align-items: center;"></div>
 ...
 <!-- Table -->
            <font size="2" style=" font-family: Arial, Helvetica, sans-serif;" >
            <table id='empTable2' class='display dataTable' style="font-size: 11.5px;">
                <thead>
                <tr>
